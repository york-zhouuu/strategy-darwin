...
机器连续运转至今:**~20 个策略,横跨 3 个市场、4 种线索来源(经典论文 / 人工直觉 / LLM 自挖掘 / 尸检报告派生的第二代),全部阵亡,零幸存。** 包括唯一通过审判的那个(加密冷门币做空,命中率 71%)——也被落地体检以"资金费+滑点吃光利润"拦下。完整名单与死因见 [`产品说明文档.md`](./产品说明文档.md) §5,每条判决书可在 `runs/`、`docs/` 复查。
